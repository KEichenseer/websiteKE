...
You can find the full R code to reproduce all analyses and figures on [Github](https://github.com/KEichenseer/Bayesian-Models/blob/main/03-Adaptive_Metropolis_algorithm_in_R).