...
summary: To work well, the Metropolis algorithm relies on good proposal values. Here, I show how draws from the posterior can be used to iteratively improve proposals, resulting in more efficient sampling.
...
error_polygon(xd,rep(0,length(xd)),dnorm(xd,p1,2)*1.8,col2)
...
We set the initial standard deviation of the proposals to $5$. 
```{r, warning = FALSE, echo = TRUE}
### Taking samples
set.seed(10)
